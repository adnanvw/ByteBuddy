...
import AddByteBuddy from "../Components/AddByteBuddy.js";
...
function Home() {
  ...
  const [ByteBuddy, setByteBuddy] = useState();
  ...
  return (
    <div className="home">
      {/* Chat Adding Card */}
      <AddByteBuddy addchattoggler={() => { addchatToggler(); }} addchattoggle={addtoggle} />
            ...
            <>
              <div className="chatroom-header">
                <div className="chatroom-chatinfo">
                  <img className='ByteBuddynnectnnectnnectnnect-profilepic' src={ByteBuddy?.photo ? API_URL + "photo/" + ByteBuddy?.photo : "assets/noavatar.jpg"} alt='' />

                  <div className="chatroom-chatinfo-right">
                    <div className="chatroom-chatinfo-name">
                      <p>{ByteBuddy?.username}</p>
                    </div>
                  </div>
                </div>
              </div>
